...
def coverage():
    ...
    '''
    cmd = line(docker_exec() + '-e REPO_ENV=True {repo} ' + pytest() + cmd)
    return cmd
...
def console():
    ...
    '''
    Returns:
        str: Blender python console command.
    '''
    return '''/home/ubuntu/blender/blender
...
def python_expression():
    # type () -> str
    '''
    Returns:
        str: Blender python expression command.
    '''
    return '''/home/ubuntu/blender/blender
        --python-use-system-env
        --background
...
def pytest():
    ...
    '''
    Returns:
        str: Pytest command run with blender.
    '''
    return '''/home/ubuntu/blender/blender
        --python-use-system-env
        --background
        --python /home/ubuntu/{repo}/docker/run_pytest.py'''
...
def sphinx():
    ...
    '''
    Returns:
        str: Sphinx command run with blender.
    '''
    return '''pandoc
...
def app_command():
    ...
    cmd = '''
        -e DEBUG_MODE=True
        -e REPO_ENV=True {{repo}}
        {python} /home/ubuntu/{{repo}}/python/{{repo}}/server/app.py
    '''
    cmd = cmd.format(python=python())
    cmds = [
        enter_repo(),
        start(),
...
def docs_command():
    ...
    cmds = [
        ...
        make_docs_dir(),
        line(
            docker_exec() + '-e REPO_ENV=True {repo} zsh -c "' + sphinx() + '"'
        ),
        exit_repo(),
    ]
    return resolve(cmds)
...
def full_docs_command():
    ...
    cmds = [
        ...
        start(),
        make_docs_dir(),
        docker_exec() + '-e REPO_ENV=True {repo} zsh -c "' + cmd + '"',
        exit_repo(),
    ]
    return resolve(cmds)
...
def python_command():
    ...
    cmds = [
        enter_repo(),
        start(),
        docker_exec() + line('''-e REPO_ENV=True {repo} zsh -c
                "/home/ubuntu/blender/blender --python-console --background"
        '''),
        exit_repo(),
    ]
    return resolve(cmds)
